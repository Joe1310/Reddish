    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <x-text-input id="alias" class="block mt-1 w-full" type="text" name="alias" :value="old('alias')" required />
            ...
            <div class="mt-4">
                ...
                <select id="rank" class="block mt-1 w-full" name="rank" required>
                    ...
                    <option value="uncalibrated" selected>Uncalibrated</option>
                </select>
